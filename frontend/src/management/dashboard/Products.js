...
import { getProductStats } from '../../actions/reports';
...
import TradingTable from '../../components/Tables/ProductTable';
...
class Customers extends React.Component {
  ...
  componentDidMount() {
    this.props.getProductStats(this.props.token);
  }
...
const mapStateToProps = state =>({
    records: state.reports.productstats,
