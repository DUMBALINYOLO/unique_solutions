...
import PartiallyPaidDetail  from './PartiallyPaidDetail';
    ...
    return (
      <ManagementLayout>
        <div className={classes.root}>
          ...
          {value === 0 && <TabContainer><PartiallyPaidDetail invoicelines={invoicelines} payments={payments} invoice={invoice}  /></TabContainer>}
