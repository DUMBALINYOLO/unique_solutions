...
const Invoices = (props) => {
    ...
    const handleClick = (status, id) =>{
      ...
      if (status === 'unpaid'){
        history.push(`/bursardashboard/unpaid-invoices/${id}`)
      }else if (status === 'partially'){
        history.push(`/bursardashboard/partially-paid-invoices/${id}`)
      }else if (status === 'fully'){
        history.push(`/bursardashboard/fully-paid-invoices/${id}`)
      }else if (status === 'voided'){
        history.push(`/bursardashboard/voided-invoices/${id}`)
      }
