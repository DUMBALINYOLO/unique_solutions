    ...
    <Fragment>
      <Grid container spacing={4}>
        <Grid item xs={12} ml={6} lg={8}>
          ...
          <Card className="card-box mb-4 d-flex bg-royal card-box-hover-rise flex-row flex-wrap justify-content-center">
        ...
        <Grid item xs={12} ml={6} lg={4}>
          <Card className="card-box mb-4 bg-royal card-box-hover-rise pt-4">
